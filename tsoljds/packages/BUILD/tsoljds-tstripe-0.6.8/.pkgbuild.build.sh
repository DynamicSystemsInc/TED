...
RPM_DOC_DIR="/usr/share/doc/packages/SUNWtgnome-tstripe"
export RPM_DOC_DIR
RPM_PACKAGE_NAME="SUNWtgnome-tstripe"
RPM_PACKAGE_VERSION="0.6.8"
RPM_PACKAGE_RELEASE="0"
export RPM_PACKAGE_NAME RPM_PACKAGE_VERSION RPM_PACKAGE_RELEASE
RPM_BUILD_ROOT="/var/tmp/pkgbuild-gfaden/SUNWtgnome-tstripe-0.6.8-build"
