...
/* NONE:UINT,STRING,STRING (gpm-marshal.list:3) */
extern void gpm_marshal_VOID__UINT_STRING_STRING (GClosure     *closure,
                                                  GValue       *return_value,
                                                  guint         n_param_values,
                                                  const GValue *param_values,
                                                  gpointer      invocation_hint,
                                                  gpointer      marshal_data);
#define gpm_marshal_NONE__UINT_STRING_STRING	gpm_marshal_VOID__UINT_STRING_STRING
